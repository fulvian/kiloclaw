      ...
      if (Flag.KILO_ROUTING_AGENCY_CONTEXT_ENABLED && agencyContext) {
        ...
        if (agencyContext.agencyId === "agency-knowledge") {
          ...
          agencyBlock = [
            ...
            "- Authorized tools in NBA Agency sessions: skill, websearch, webfetch",
            "- After loading nba-analysis, use websearch/webfetch to gather live data for missing fields",
            "- Prefer official/reputable sources (NBA, ESPN, The Odds API, major bookmakers) and keep source alignment explicit",
            ...
            "Available tools: nba-analysis skill (REQUIRED), plus websearch and webfetch for live source retrieval.",
