...
const COMMON_ISSUES = {
  typescript: [
    ...
    },
    {
      ...
      message: "Use 'const' if variable is never reassigned",
    },
    {
      rule: "no-console",
  ...
  python: [
    ...
    },
    {
      ...
      pattern: /^print\s+(?![(])/,
      severity: "info" as IssueSeverity,
      message: "Use print() function for Python 3 compatibility",
    },
    {
      rule: "noBareExcept",
      pattern: /except\s*:/,
  ...
  default: [
    ...
    },
    {
      ...
      pattern: /\n{3,}/,
      severity: "minor" as IssueSeverity,
      message: "Limit consecutive empty lines to 2",
    },
  ],
}
...
function detectIssues(code: string, language: string): Issue[] {
  ...
  const bugPatterns = [
    ...
    { pattern: /!=\s*(?!['"])/, severity: "major" as IssueSeverity, message: "Use !== instead of !=" },
    {
      ...
      severity: "info" as IssueSeverity,
      message: "Missing semicolon or inconsistent formatting",
    },
  ]
