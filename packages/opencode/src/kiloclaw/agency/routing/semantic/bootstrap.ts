  ...
  const capabilities = [
    {
      ...
      keywords: ["weather", "forecast", "temperature", "meteo", "previsioni"],
      capabilities: ["weather-forecast", "forecast"],
    },
    {
      id: "weather_current",
      domain: "weather" as Domain,
      description: "Get current weather conditions",
      keywords: ["weather", "current", "now", "today", "meteo", "attuale"],
      capabilities: ["weather-current", "current-weather"],
    },
    {
      id: "weather_alerts",
      domain: "weather" as Domain,
      description: "Get weather alerts and warnings",
      keywords: ["weather", "alert", "alerts", "warning", "warnings", "allerta"],
      capabilities: ["weather-alerts", "alerts"],
    },
    {
      id: "location_weather",
      domain: "weather" as Domain,
      description: "Get weather for a specific location",
      keywords: ["location", "place", "city", "location", "luogo", "città"],
      capabilities: ["location-weather", "local-weather"],
    },
  ]
