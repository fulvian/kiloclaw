...
const POLICY: Record<string, Record<string, PolicyLevel>> = {
  ...
  slides: {
    "presentations.get": "SAFE",
    "presentations.list": "SAFE",
    "presentations.search": "SAFE",
    "presentations.export": "SAFE",
    "presentations.create": "CONFIRM",
    "presentations.addslide": "CONFIRM",
    "presentations.update": "CONFIRM",
    "presentations.delete": "CONFIRM",
  },
  search: {
    "documents.search": "SAFE",
    "documents.tag": "SAFE",
...
const ALIAS: Record<string, Record<string, string>> = {
  ...
  docs: {
    ...
    "docs.download": "documents.export",
    "docs.export": "documents.export",
  ...
  slides: {
    ...
    search: "presentations.search",
    list: "presentations.list",
    download: "presentations.export",
    export: "presentations.export",
    create: "presentations.create",
    addslide: "presentations.addslide",
    update: "presentations.update",
    delete: "presentations.delete",
    "slides.read": "presentations.get",
    "slides.download": "presentations.export",
    "slides.export": "presentations.export",
    "slides.create": "presentations.create",
    "slides.addslide": "presentations.addslide",
    "slides.update": "presentations.update",
    "slides.delete": "presentations.delete",
  },
  search: {
    search: "documents.search",
    tag: "documents.tag",
