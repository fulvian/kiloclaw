...
export namespace Flag {
  ...
  // =============================================================================
  // Runtime Remediation - P0/P1 Skills/Tools Runtime Remediation
  // KILOCLAW_SKILLS_TOOLS_RUNTIME_REMEDIATION_PLAN_2026-04-12.md
  // =============================================================================

  // P0: Tool Identity Resolver
  export const KILO_RUNTIME_TOOL_IDENTITY_RESOLVER_ENABLED = truthy("KILO_RUNTIME_TOOL_IDENTITY_RESOLVER_ENABLED")
  export const KILO_RUNTIME_TOOL_IDENTITY_RESOLVER_SHADOW = !falsy("KILO_RUNTIME_TOOL_IDENTITY_RESOLVER_SHADOW")

  // P1: Session Execution Bridge
  export const KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_ENABLED = truthy("KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_ENABLED")
  export const KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_SHADOW = !falsy("KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_SHADOW")
  export const KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_MAX_STEPS =
    number("KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_MAX_STEPS") ?? 10
  export const KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_TIMEOUT_MS =
    number("KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_TIMEOUT_MS") ?? 60_000

  // P1: Skill Tool Execute Mode
  export const KILO_RUNTIME_SKILL_TOOL_EXECUTE_MODE_ENABLED = truthy("KILO_RUNTIME_SKILL_TOOL_EXECUTE_MODE_ENABLED")
  export const KILO_RUNTIME_SKILL_NO_SILENT_FALLBACK = !falsy("KILO_RUNTIME_SKILL_NO_SILENT_FALLBACK")

  // P1: Agency-specific resolver/bridge flags
  export const KILO_RUNTIME_AGENCY_KNOWLEDGE_RESOLVER_ENABLED = truthy("KILO_RUNTIME_AGENCY_KNOWLEDGE_RESOLVER_ENABLED")
  export const KILO_RUNTIME_AGENCY_GWORKSPACE_RESOLVER_ENABLED = truthy(
    "KILO_RUNTIME_AGENCY_GWORKSPACE_RESOLVER_ENABLED",
  )
  export const KILO_RUNTIME_AGENCY_FINANCE_RESOLVER_ENABLED = truthy("KILO_RUNTIME_AGENCY_FINANCE_RESOLVER_ENABLED")
  export const KILO_RUNTIME_AGENCY_NBA_RESOLVER_ENABLED = truthy("KILO_RUNTIME_AGENCY_NBA_RESOLVER_ENABLED")
  export const KILO_RUNTIME_AGENCY_DEVELOPMENT_RESOLVER_ENABLED = truthy(
    "KILO_RUNTIME_AGENCY_DEVELOPMENT_RESOLVER_ENABLED",
  )

  export const KILO_RUNTIME_AGENCY_KNOWLEDGE_BRIDGE_ENABLED = truthy("KILO_RUNTIME_AGENCY_KNOWLEDGE_BRIDGE_ENABLED")
  export const KILO_RUNTIME_AGENCY_GWORKSPACE_BRIDGE_ENABLED = truthy("KILO_RUNTIME_AGENCY_GWORKSPACE_BRIDGE_ENABLED")
  export const KILO_RUNTIME_AGENCY_FINANCE_BRIDGE_ENABLED = truthy("KILO_RUNTIME_AGENCY_FINANCE_BRIDGE_ENABLED")
  export const KILO_RUNTIME_AGENCY_NBA_BRIDGE_ENABLED = truthy("KILO_RUNTIME_AGENCY_NBA_BRIDGE_ENABLED")
  export const KILO_RUNTIME_AGENCY_DEVELOPMENT_BRIDGE_ENABLED = truthy("KILO_RUNTIME_AGENCY_DEVELOPMENT_BRIDGE_ENABLED")

  // P1: Metric thresholds
  export const KILO_RUNTIME_POLICY_ALIAS_MISS_THRESHOLD = number("KILO_RUNTIME_POLICY_ALIAS_MISS_THRESHOLD") ?? 2
  export const KILO_RUNTIME_SKILL_NOT_EXECUTED_THRESHOLD = number("KILO_RUNTIME_SKILL_NOT_EXECUTED_THRESHOLD") ?? 0
  export const KILO_RUNTIME_GENERIC_FALLBACK_RATE_THRESHOLD =
    number("KILO_RUNTIME_GENERIC_FALLBACK_RATE_THRESHOLD") ?? 20
  export const KILO_RUNTIME_AGENCY_CHAIN_SUCCESS_THRESHOLD = number("KILO_RUNTIME_AGENCY_CHAIN_SUCCESS_THRESHOLD") ?? 95
}
