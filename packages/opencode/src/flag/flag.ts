...
export namespace Flag {
  ...
  export let KILO_RUNTIME_TOOL_IDENTITY_RESOLVER_ENABLED = truthy("KILO_RUNTIME_TOOL_IDENTITY_RESOLVER_ENABLED")
  ...
  export let KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_ENABLED = truthy("KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_ENABLED")
  ...
  export let KILO_RUNTIME_SKILL_TOOL_EXECUTE_MODE_ENABLED = truthy("KILO_RUNTIME_SKILL_TOOL_EXECUTE_MODE_ENABLED")
  export let KILO_RUNTIME_SKILL_NO_SILENT_FALLBACK = !falsy("KILO_RUNTIME_SKILL_NO_SILENT_FALLBACK")
