...
export namespace Flag {
  ...
  export let KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_ENABLED = true // kilocode_change - always enabled
  export const KILO_RUNTIME_SESSION_EXECUTION_BRIDGE_SHADOW = false // kilocode_change - disabled
  ...
  export let KILO_RUNTIME_SKILL_TOOL_EXECUTE_MODE_ENABLED = true // kilocode_change - always enabled
  export let KILO_RUNTIME_SKILL_NO_SILENT_FALLBACK = true // kilocode_change - always warn
