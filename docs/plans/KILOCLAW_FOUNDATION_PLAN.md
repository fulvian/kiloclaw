...
- [ ] CI baseline verde su branch principale
- [ ] ADR approvate da architect + orchestrator
- [ ] Inventario feature ARIA validato da owner funzionali
- [ ] Nessun blocco critico su licensing/naming/schema URLs
...
### Test/verification checklist
- [ ] Copertura contract runtime su path happy + failure principali
- [ ] Error taxonomy coerente e documentata
- [ ] Benchmark latenza base entro SLO target
- [ ] Nessuna dipendenza ciclica nei moduli core
